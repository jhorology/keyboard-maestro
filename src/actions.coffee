...
exports.ids = [
    ...
    'cursor track - activated - toggle'
    'cursor track - volume - +10%'
    'cursor track - volume - +1%'
    'cursor track - volume - -1%'
    'cursor track - volume - -10%'
    'cursor track - volume - reset'
    'cursor track - pan - right 10%'
    'cursor track - pan - right 1%'
    'cursor track - pan - left 1%'
    'cursor track - pan - left 10%'
    'cursor track - pan - reset'
    'cursor track - mute - toggle'
    'cursor track - solo - toggle'
    'cursor track - send S1 - +10%'
    'cursor track - send S1 - +1%'
    'cursor track - send S1 - -1%'
    'cursor track - send S1 - -10%'
    'cursor track - send S1 - reset'
    'cursor track - send S2 - +10%'
    'cursor track - send S2 - +1%'
    'cursor track - send S2 - -1%'
    'cursor track - send S2 - -10%'
    'cursor track - send S2 - reset'
    'cursor track - send S3 - +10%'
    'cursor track - send S3 - +1%'
    'cursor track - send S3 - +1%'
    'cursor track - send S3 - +10%'
    'cursor track - send S3 - reset'
    'cursor track - send S4 - +10%'
    'cursor track - send S4 - +1%'
    'cursor track - send S4 - -1%'
    'cursor track - send S4 - -10%'
    'cursor track - send S4 - reset'
    'cursor track - arm - toggle'
    'cursor track - monitor - toggle'
    'cursor track - auto monitor - toggle'
    'cursor track - crossfade - mode A'
    'cursor track - crossfade - mode B'
    'cursor track - crossfade - mode AB'
    'cursor track - clip launcher - stop'
    'cursor track - clip laucner - preturn to arrangement'
]
